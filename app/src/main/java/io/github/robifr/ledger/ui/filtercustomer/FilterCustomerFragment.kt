...
package io.github.robifr.ledger.ui.filtercustomer
...
import io.github.robifr.ledger.ui.filtercustomer.recycler.FilterCustomerAdapter
import io.github.robifr.ledger.ui.filtercustomer.viewmodel.FilterCustomerEvent
import io.github.robifr.ledger.ui.filtercustomer.viewmodel.FilterCustomerResultState
import io.github.robifr.ledger.ui.filtercustomer.viewmodel.FilterCustomerViewModel
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    fragmentBinding.recyclerView.addOnScrollListener(
        PaginationScrollListener(
            ...
            _onLoadPreviousPage = { filterCustomerViewModel.onLoadPreviousPage() },
            _onLoadNextPage = { filterCustomerViewModel.onLoadNextPage() },
            _isLoading = { filterCustomerViewModel.uiState.safeValue.pagination.isLoading },
            _onStateIdle = filterCustomerViewModel::onRecyclerStateIdle,
            _maxItems = {
              filterCustomerViewModel.uiState.safeValue.pagination.paginatedItems.size
            }))
  ...
  private fun _onSearchCustomerResult(requestKey: String, result: Bundle) {
    when (SearchCustomerFragment.Request.entries.find { it.key() == requestKey }) {
      SearchCustomerFragment.Request.SELECT_CUSTOMER -> {
        ...
        if (customerId != 0L) {
          filterCustomerViewModel.uiState.safeValue.pagination.paginatedItems
