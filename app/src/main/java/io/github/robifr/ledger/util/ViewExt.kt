...
package io.github.robifr.ledger.util
...
fun View.showKeyboard() {
  ...
  post { inputManager.showSoftInput(rootView.findFocus(), InputMethodManager.SHOW_IMPLICIT) }
}

fun View.hideKeyboard() {
  val inputManager: InputMethodManager =
      context.getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager
  post { inputManager.hideSoftInputFromWindow(rootView.findFocus()?.windowToken, 0) }
}
