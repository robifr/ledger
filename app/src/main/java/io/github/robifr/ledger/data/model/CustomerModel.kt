...
/**
 * @property id Customer unique ID. Set to null for the value to be auto-generated by Room.
 * @property name Customer name.
 * @property balance Customer balance in the lowest currency unit.
 * @property debt Customer debt in the lowest currency unit and stored as a negative number, by
 *   counting [ProductOrderModel.totalPrice] from queues whose status is [QueueModel.Status.UNPAID].
 *   Use [CustomerDao.totalDebtById] to count current total debt.
 * @see Model.id
 */
@Parcelize
