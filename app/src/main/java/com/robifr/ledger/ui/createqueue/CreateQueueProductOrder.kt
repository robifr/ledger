...
class CreateQueueProductOrder(private val _fragment: CreateQueueFragment) {
  ...
  fun setCustomerBalanceAfterPaymentTitle(title: String?, isVisible: Boolean) {
    _fragment.fragmentBinding.productOrder.customerBalanceTitle.setText(title)
  ...
  fun setCustomerDebtAfterPaymentTitle(title: String?, isVisible: Boolean) {
    _fragment.fragmentBinding.productOrder.customerDebtTitle.setText(title)
