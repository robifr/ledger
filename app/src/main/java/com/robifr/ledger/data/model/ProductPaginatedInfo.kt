...
data class ProductPaginatedInfo(
    @ColumnInfo(name = "id") override val id: Long?,
    @ColumnInfo(name = "name") val name: String,
    @ColumnInfo(name = "price") val price: Long,
    @Ignore val fullModel: ProductModel? = null
) : Info {
  ...
  constructor(product: ProductModel) : this(product.id, product.name, product.price, product)
}
