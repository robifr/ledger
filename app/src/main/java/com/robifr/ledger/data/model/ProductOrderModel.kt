...
/**
 * @property id Product order unique ID. Set to null for the value to be auto-generated by Room.
 * @property queueId Referenced queue ID from [QueueModel.id].
 * @property productId Referenced product ID from [ProductModel.id].
  ...
  companion object {
    ...
    fun calculateTotalPrice(productPrice: Long?, quantity: Double, discount: Long): BigDecimal {
      val totalPrice: BigDecimal =
          productPrice?.let {
            it.toBigDecimal() * quantity.toBigDecimal().stripTrailingZeros() -
