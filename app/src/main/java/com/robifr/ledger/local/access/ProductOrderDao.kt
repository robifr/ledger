...
abstract class ProductOrderDao : QueryAccessible<ProductOrderModel> {
  ...
  /** @return List of inserted row ID. -1 for any failed operation. */
  ...
  @Delete abstract override fun delete(productOrder: ProductOrderModel): Int
  ...
  /** @return Upserted row IDs. -1 for any failed operation. */
